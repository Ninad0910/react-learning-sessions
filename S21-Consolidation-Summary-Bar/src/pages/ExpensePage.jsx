...
export default function ExpensePage() {
  const { updateExpense, setUpdateExpense } = useExpenseContext()
  ...
  function confirmDelete() {
    ...
    setShowModal(false)
    const deletedExpense = updateExpense.find(
      (exp) => exp.id === pendingDeleteId,
    )
  ...
  return (
    <section className="min-h-screen flex flex-col items-center bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-4 py-8 transition-colors duration-300">
      ...
      >
        ...
        >
          <ExpenseForm setToastMessage={setToastMessage} />
        </Suspense>
      ...
      <SummaryBar filteredExpenses={filteredExpenses} />
